...
def tarea_generar_resumen_ia(self, resumen_pk):
    ...
    try:
        ReporteService.generar_resumen_con_llm(resumen_pk=resumen_pk)
...
def tarea_marcar_resumenes_ia_vencidos():
    ...
    count = ReporteService.marcar_resumenes_ia_vencidos()
...
def tarea_procesar_mensaje_chat(self, mensaje_pk):
    ...
    try:
        ReporteService.procesar_mensaje_con_llm(mensaje_pk=mensaje_pk)
    except Exception as exc:
...
def tarea_marcar_chats_vencidos():
    ...
    count = ReporteService.marcar_chats_vencidos()
